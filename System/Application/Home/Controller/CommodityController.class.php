...
class CommodityController extends Controller{
    ...
    public function lists(){
        ...
        list($paging, $results) = D(self::$COMMODITY_MODEL)->lists();
    ...
    public function hotlists(){
        ...
        validateUnLoginRedirect();
        checkAccess('commodity','view');
        list($paging, $results) = D(self::$COMMODITY_MODEL)->hotlists();
        $this->assign('paging', $paging);
        $this->assign('results', $results);
        $this->display();
    }
    ...
    public function recommendlists(){
        ...
        validateUnLoginRedirect();
        checkAccess('commodity','view');
        list($paging, $results) = D(self::$COMMODITY_MODEL)->recommendlists();
        $this->assign('paging', $paging);
        $this->assign('results', $results);
        $this->display();
    }
    ...
    public function quantitylists(){
        ...
        validateUnLoginRedirect();
        checkAccess('commodity','view');
        list($paging, $results) = D(self::$COMMODITY_MODEL)->quantitylists();
        $this->assign('paging', $paging);
        $this->assign('results', $results);
        $this->display();
    }
    ...
    public function raedit(){
        ...
        $category=D(self::$CATEGORY_MODEL)->get();
        $result=D(self::$COMMODITY_MODEL)->getResultByConditions(array('id'=>I('get.id')));
    ...
    public function hotchange(){
        try{
            ...
            validateUnLoginRedirect();
            checkAjaxAccess('commodity','raedit');
            D(self::$COMMODITY_MODEL)->hotchange();
            $ajaxReturnData['status']=1;
            $ajaxReturnData['message']='操作成功';
        }catch(\Exception $e){
            $ajaxReturnData['status']=0;
    ...
    public function recommendchange(){
        try{
            ...
            validateUnLoginRedirect();
            checkAjaxAccess('commodity','raedit');
            D(self::$COMMODITY_MODEL)->recommendchange();
            $ajaxReturnData['status']=1;
            $ajaxReturnData['message']='操作成功';
        }catch(\Exception $e){
            $ajaxReturnData['status']=0;
    ...
    public function quantitychange(){
        try{
            ...
            validateUnLoginRedirect();
            checkAjaxAccess('commodity','raedit');
            D(self::$COMMODITY_MODEL)->quantitychange();
            $ajaxReturnData['status']=1;
            $ajaxReturnData['message']='操作成功';
        }catch(\Exception $e){
            $ajaxReturnData['status']=0;
    ...
    public function adds_do(){
        try{
            validateUnLoginRedirect();
            checkAjaxAccess('commodity','add');
            D(self::$COMMODITY_MODEL)->adds();
            $ajaxReturnData['status']=1;
            $ajaxReturnData['message']='操作成功';
        }catch(\Exception $e){
            $ajaxReturnData['status']=0;
