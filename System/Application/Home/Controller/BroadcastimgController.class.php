...
class BroadcastimgController extends Controller{
    ...
    public function lists(){
        ...
        list($paging, $results) = D(self::$BROADCASTIMG_MODEL)->lists();
    ...
    public function dele_do(){
        try{
            ...
            D(self::$BROADCASTIMG_MODEL)->dele();
    ...
    public function raedit(){
        ...
        $result=D(self::$BROADCASTIMG_MODEL)->getResultByConditions(array('id'=>I('get.id')));
        // var_dump($result);
        // var_dump($category);
    ...
    public function raedit_do(){
        try{
            ...
            D(self::$BROADCASTIMG_MODEL)->raedit();
            $ajaxReturnData['status']=1;
            $ajaxReturnData['message']='操作成功';
        }catch(\Exception $e){
            $ajaxReturnData['status']=0;
    ...
    public function adds_do(){
        try{
            validateUnLoginRedirect();
            D(self::$BROADCASTIMG_MODEL)->adds();
            $ajaxReturnData['status']=1;
            $ajaxReturnData['message']='操作成功';
        }catch(\Exception $e){
            $ajaxReturnData['status']=0;
