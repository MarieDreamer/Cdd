...
class AlbumShowController extends Controller{
    ...
    static $ALBUM_SHOW_MODEL='AlbumShow';
...
//
    public function lists(){
        ...
        list($paging, $results) = D(self::$ALBUM_SHOW_MODEL)->lists();
    ...
    public function raedit(){
        ...
        $result=D(self::$ALBUM_SHOW_MODEL)->getResultByConditions(array('id'=>I('get.id')));
    ...
    public function raedit_do(){
        try{
            ...
            D(self::$ALBUM_SHOW_MODEL)->raedit();
            $ajaxReturnData['status']=1;
            $ajaxReturnData['message']='操作成功';
        }catch(\Exception $e){
            $ajaxReturnData['status']=0;
