...
<div class="wrapper wrapper-content animated fadeInRight">
                    ...
                    <div class="example-wrap">
                        <div class="example">
                            <div class="btn-group" role="group">
                                <a href="/Commodity/adds" class="btn btn-outline btn-default">
                                    <i class="glyphicon glyphicon-plus" aria-hidden="true"></i> 添加商品
                                </a>
                            </div>
                            <h1>Commodity商品管理</h1>
 ...
 $urls=json_decode($vo['shop_index_image'],true); foreach ($urls as $key => $value) { ?>
                                        ...
                                        <td>
                                            ...
                                            <a title="添加到热卖" class="hot"><?php echo ($vo['hot']); ?></a>&nbsp;&nbsp;&nbsp;
                                            <a title="添加到热卖" class="recommend"><?php echo ($vo['recommend']); ?></a>&nbsp;&nbsp;&nbsp;
