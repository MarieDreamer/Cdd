            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <div class="form-horizontal m-t" id="commentForm">
                        ...
                        <div class="form-group">
                                <label class="col-sm-2 control-label">商品减免价格</label>
                                <div class="col-sm-8">
                                    <input type="text" size="30"  size="80" minlength="6" maxlength="60" class="form-control"  id="last_price"  value="<?php echo $result['last_price'];?>"/>
                                </div>
                            </div>
