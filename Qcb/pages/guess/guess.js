...
Page({
    ...
    onLoad: function(t) {
        ...
        wx.request({
          url: 'https://wechat.cdd.jianfengweb.com/Order/get_term_number',
          success:function(res){
            console.log(res)
            that.setData({
              term_number: res.data.data.guess_term_number
            })
          }
        })
    ...
    single:function(t){
      ...
      var id=that.data.id;
      wx.request({
        url: 'https://wechat.cdd.jianfengweb.com/Order/guess_do',
        data:{
          id:id,
          dan:1,
        },
        success: function(res){
            ...
            } else if (res.data.data.data == '请勿重复猜奖') {
              wx.showToast({
                title: '请勿重复猜奖',
              })
            }
