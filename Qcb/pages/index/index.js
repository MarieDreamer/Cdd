...
Page({
    ...
    onLoad: function(e) {
        ...
        wx.request({
          url: 'https://wechat.cdd.jianfengweb.com/Commodity/index',
          data: {
          },
          success: function (res) {
            // console.log(res.data.recommend)
            var recommendarray = res.data.recommend;
            var hotlistsarray = res.data.hotlists;
            s.setData({
              recommendarray: recommendarray
            })
            s.setData({
              hotlistsarray: hotlistsarray
            })
          },
        })

        wx.request({
          url: 'https://wechat.cdd.jianfengweb.com/Broadcastimg/index',
          data: {
          },
          success: function (res) {
            // console.log(res.data.data)
            var broadcastimgarray = res.data.data;
            s.setData({
              broadcastimgarray: broadcastimgarray
            })
            // console.log(broadcastimgarray);
          },
        })
    },
    onShow:function(){
